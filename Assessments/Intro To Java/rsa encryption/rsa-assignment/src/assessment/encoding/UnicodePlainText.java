...
public class UnicodePlainText extends PlainText {
	...
	/**
	 * handles conversion between Unicode strings
	 * and BigIntegers
	 */
	...
	public String convertBigInteger(BigInteger b) {
		/**
		...
		String[] characterCodes = StringLibrary.splitAtInterval(messageString, unicodeDecimalLength);
